#' Geo-referenced California wildfire records from 2001 - 2015
#'
...
#' the date (2000 - 2015), state (CA), and key cols and cleaning up the
...
#'
#' @format A dataframe with 51833 rows and 11 variables:
#' \describe{
...
#' Air quality data records for California from 2001 - 2015
#'
...
#'
#' @format A dataframe with 302242 rows and 10 variables:
#' \describe{
...
#' Daily weather summaries for California from 2001 - 2015
#'
...
#' and by filtering on the date (2000 - 2015), state (CA), and key cols.
#'
...
#'
#' @format A dataframe with 317644 rows and 7 variables:
#' \describe{
...
#' Master dataset combining the wildfires, AQI, and climate data for California from 2000 - 2015
#'
#' The master dataframe takes each wildfire occurrence in California
#' between 2001 and 2015, and joins the AQI and climate data for 30 days
...
#'
#' @format A dataframe with 2194004 rows and 23 variables:
#' \describe{
#'   \item{FIRE_NAME}{Name of the incident, from the fire report (primary) or ICS-209 report (secondary)}
#'   \item{DISCOVER_DATE}{Date on which the fire was discovered or confirmed to exist}
#'   \item{CONT_DATE}{Date on which the fire was declared contained or otherwise controlled}
